...
- The application runs at port 8081 because I used VS Code CDE (Cloud Development Environment) running at port 8080. You can just change the application.properties file located in src/main/resources by removing the specific port lines to run the default 8080.
